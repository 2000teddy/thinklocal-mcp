...
existiert. Fail-closed an jeder Kante (Resolver-Throw/malformed ⇒ 403). CO: `pal:consensus` (Reorder
TL-09b vor TL-10, nutzerbestätigt). +11 Tests, 1598 grün. Neu: `deriveToolName`; `ApprovalRequest.tier`
