...
| **D2** | `pathLenConstraint` der Root | **`0`** (Intermediates dürfen keine Sub-CAs) | CO | Zeremonie-Skript, D6 | ✅ beschlossen **per Consensus (2026-07-19)** — CO/technisch, **kein** Owner-Sign-off nötig |
...
> (D3 = **24 Monate**; D1/D4/D5/D6 mit-bestätigt (D2 = CO/technisch, bereits per Consensus entschieden, nicht Teil der Sign-off-Tabelle)) — **ADR-045 ist `Accepted`** und ab jetzt die maßgebliche
