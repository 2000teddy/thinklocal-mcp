...
- [ ] 🔴 **Identität auf libp2p-PeerID umstellen** — Konsens (2 pal:consensus-Läufe, einstimmig Option 1),
  ...
  **Umsetzung (Schritt 1 erledigt — Commit `1683396`, s. CHANGES 2026-06-03):**
  ...
  - [ ] **OFFEN (Ops, GATE):** TH02-Live-Re-Verifikation des Flips mit v0.34.1 (sauberer Flip, Announces 200 statt 403) → DANN Per-Node-Produktiv-Flip + Noise-Re-Handshake + Gegenprobe; danach `TLMCP_STRICT_IDENTITY=1` + Legacy-Pfad entfernen. Produktiv-Flip bleibt bis dahin gestoppt.
