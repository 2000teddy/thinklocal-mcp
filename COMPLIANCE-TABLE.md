...
*Letzte Aktualisierung: 2026-07-22 10:45 — feat(gate): TL-10 D2-Prep `MeldekanalRegistry.requestApprovalOn(channelId, req)`; gezielte Kanal-Bindungs-Primitive (statt „erster gesunder"), fail-closed & verhaltensgleich zu requestApproval ohne Fallback; `requestApproval` unverändert, 0 Aufrufer/kein Matrix-Wiring/kein Env-Flag; +10 Tests, Suite 1932 grün, CR GREEN; Ingress/Matrix/D3 bleiben Slice-B-gated; kein Deploy/Secret.*
