...
*Letzte Aktualisierung: 2026-07-21 16:10 — test(tls): TL-14a Slice A D2-Invariante (Intermediate mit pathLen 0 darf keine Sub-CA ausstellen); fokussierter Negativtest in `chain-verify.test.ts` (Constraint am Intermediate isoliert, gepaarte Gegenprobe), Code #298/#299 unverändert; +1 Test, Suite 1857 grün; test-only, kein Deploy/Secret.*
