...
*Letzte Aktualisierung: 2026-07-20 16:36 — feat(mcp): TL-21 Peer-Skelett als MCP-Tool (`list_peers_overview`); additives read-only MCP-Companion zu `GET /api/peers/overview` (#303), gemeinsamer Builder `buildPeerOverview` REST+MCP (kein Drift), keine Korrektheits-Bugs im CR; index.ts unangetastet.*
