...
*Letzte Aktualisierung: 2026-07-22 08:30 — feat(mcp): TL-08 Slice 2c Live-Tool-Class-Drift-Check-Hook (ADR-042); ehrliche Verdrahtung des `checkToolClassDrift`-Seams (governed Server → LIVE tools/list über vorhandene mTLS-Forward-Primitive, secret-sicher, TOOL_CLASS_DRIFT-Audit, kein Gate-Flip); fail-safe in index.ts (unref+Shutdown); CR 1 MEDIUM (M1 false-positive) gefixt, kein HIGH; +22 Tests, Suite 1919 grün; kein Deploy/Secret.*
