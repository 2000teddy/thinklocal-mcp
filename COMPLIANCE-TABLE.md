...
| #        | PR    | Datum            | CO  | CG | TS | CR | PC | DO | Findings                           |
|----------|-------|------------------|-----|----|----|----|----|----|------------------------------------|
| v0.34.56 | (offen, base=main) | 2026-07-01 21:15 | s.u. | n/a | ✅ | ✅ | ✅ | ✅ | CR Claude adversarial: 0× HIGH/CRIT; CR-M1 (loser SAN-Match)→strikt+Test; CR-L2 (Self-1-Hop)→T3.3-Hinweis |
...
| #        | PR    | Datum            | CO  | CG | TS | CR | PC | DO | Findings                           |
|----------|-------|------------------|-----|----|----|----|----|----|------------------------------------|
| v0.34.57 | (offen, base=#229) | 2026-07-02 06:24 | s.u. | n/a | ✅ | ✅ | ✅ | ✅ | CR Claude adversarial: 0× CRIT; 2× HIGH (H1 Cache-Key, H2 Pin-Downgrade)→gefixt+Tests; M4/L1/L4→gefixt; M1/M2/L2→ADR dokumentiert |
...
*Letzte Aktualisierung: 2026-07-02 06:24 — v0.34.57 feat(mcp): Modell-B T3.3 Live-Forward-Executor.*
