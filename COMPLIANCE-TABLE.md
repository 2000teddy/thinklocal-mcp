...
*Letzte Aktualisierung: 2026-07-22 09:45 — fix(mcp): TL-08 Slice 2c Drift-Hook Härtung gegen all-malformed tools-Array (CR-LOW #315-Review); Fetcher wirft jetzt auch bei nicht-leerem tools-Array ohne verwertbaren Namen (→ Seam → null → skip, kein false-positive „alles stale"); legitim leeres [] bleibt gültig; +3 Tests, Suite 1922 grün; read-only, kein Gate-Flip/Deploy/Secret.*
