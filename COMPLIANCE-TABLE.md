...
*Letzte Aktualisierung: 2026-07-22 06:20 — feat(wire): ADR-046 ungegateter Consumer-Kern `supportsFeature` (fail-closed, platzierungs-/vokabular-agnostisch); reiner Primitiv der §2-Invariante (absent/unknown/malformed ⇒ false), 0 Aufrufer/kein Runtime-Change; +10 Tests, Suite 1897 grün, CR GREEN; Platzierung/Vokabular/Producer bleiben CO-gated; kein Deploy/Secret.*
