...
*Letzte Aktualisierung: 2026-07-21 07:20 — docs(arch): TL-12 Slice C Scoping/Park; Gate-Check ergab PARK (first-class ORDER nicht ehrlich low-ambiguity baubar — V1 default-Drop, V2 totes version-compat, V3 AgentMessagePayload-gekoppelte Inbox); doc-only, kein Code/Deploy/Secret.*
